...
try:
    ...
    U = torch.load(os.path.join( PATH, "slosh_cheap_centered_U.pt"))
    s = torch.load(os.path.join( PATH, "slosh_cheap_centered_s.pt"))
    V = torch.load(os.path.join( PATH, "slosh_cheap_centered_V.pt"))
except:
    #
    ...
    torch.save( U, os.path.join( PATH, "slosh_cheap_centered_U.pt" ))
    torch.save( s, os.path.join( PATH, "slosh_cheap_centered_s.pt" ))
    torch.save( V, os.path.join( PATH, "slosh_cheap_centered_V.pt" ))
